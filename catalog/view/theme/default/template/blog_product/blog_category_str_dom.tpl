...
<div class="container">
<p><a href="#get-call" class=" uptocall-mini-phone2" data-effect="mfp-zoom-in">Заказать звонок</a></p>
  <div class="row">
    ...
    <div class="col-md-9 col-md-push-3">
      ...
      <div class="list-category">
        ...
        <div class="list-category__item list-category-item">
          <div class="list-category-item__title"><a href="<?php echo $category['href']; ?>"><?php echo $category['name_no_prod']; ?></a></div>

          <?php if ( isset($category['children']) && count($category['children']) > 0 ) { ?>
          <ul class="list-category-item__list">
            <?php foreach ($category['children'] as $child) { ?>
              <li><a href="<?php echo $child['href']; ?>"><?php echo $child['name_no_prod']; ?></a></li>
            <?php } ?>
          </ul>
          <?php } ?>
      ...
      <?php if ( isset($categories1) && count($categories) > 0 ) { ?>
      <div class="list-category">
           ...
           <?php if (isset($category['products']) AND count($category['products'])) { ?>
            <ul class="list-category-item__list">
              <?php foreach ($category['products'] as $product) { ?>
                  <li><a href="<?php echo $product['href']; ?>"><?php echo $product['name_no_prod']; ?></a></li>
              <?php } ?>
            </ul>
          <?php } ?>
