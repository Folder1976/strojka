...
<section class="section section-text">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="section-title">Ремонтные работы по кровле здания в Москве</div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <div class="content-style">
          <p>Компания «Руфер» производит ремонт кровельного покрытия различной сложности. Специалисты компании занимается восстановлением крыш и реставрацией кровли жилых и производственных зданий следующих видов</p>
          <ul>
            <li>Сдвижного типа;</li>
            <li>Панорамного осмотра;</li>
            <li>Плоского вида;</li>
            <li>С 2 и более скатами;</li>
            <li>Вальмового типа;</li>
            <li>Щипцовой формы;</li>
            <li>С полной или частичной мансардой;</li>
            <li>Других конструкций, в т.ч. и с усложняющими элементами.</li>
          </ul><br>
          <p>Монтажники компании обладают большим практическим опытом, соответствующим образованием и необходимыми знаниями, которые применяются для монтажа различных видов кровельных материалов:</p>
          <ul>
            <li>Мягкой консистенции (битумной черепицы, ондулина, рубероида);</li>
            <li>Из металла (профнастил, металлочерепица, панели фальцевого типа);</li>
            <li>Асбестоцементного состава (шифер плоский и волнистый, черепица из цементно-песчаной смеси);</li>
            <li>Натуральной обожжённой черепицей из глины,</li>
          </ul><br>
          <p>а также занимаемся укладкой кровли наплавного и наливного типа необходимой квадратуры и геометрии.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="section section-text">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="section-title">Сроки ремонтных работ</div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <div class="content-style">
          <p>Сроки и стоимость заказа часто связаны с его сложностью, что определяется выбором типа кровельного материала, какой вид кровли будет выбран для монтажа, а также площадь. покрытия. При затруднении с выбором заказчик может получить консультацию у наших менеджеров, которые с готовностью придут клиентам на помощь. Они профессионально помогут выбрать нужный тип покрытия и способ монтажа крыши.</p>
          <p>В случае, если в кровельном покрытии уже наблюдаются признаки разрушения и деструктивные особенности, целесообразно проведение ремонтно – восстановительных работ не затягивать, ведь точечный ремонт только усугубит проблему, но не решит ее целиком.</p>
          <p>Поэтому целесообразно планировать ремонт всей кровли для сохранности интерьера внутренних помещений, внутреннего комфорта и целости сооружения.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="section section-text">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="section-title">Стоимость ремонта</div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <div class="content-style">
          <p>Стоимость ремонтных работ по крыше определяется с помощью расходной сметы, где учитываются следующие параметры:</p>
          <ul>
            <li>Квадратура и конфигурация кровельного покрытия;</li>
            <li>Разновидность применяемой кровли;</li>
            <li>Габаритов и геометрии сооружения;</li>
            <li>Сезонности;</li>
            <li>Степени срочности.</li>
          </ul><br>
          <p>Мы предлагаем своим заказчиком оптимальную цену за единицу измерения кровельного ремонта, т.к. стоимость предлагаемых нами материалов вполне конкурентоспособна с ценами других поставщиков.</p>
          <p>Для наших заказчиков подготовлены различные акции, подарки и сезонные скидки. Из-за составления реальной сметы работ при покупке стройматериалов у наших контрагентов стоимость ремонта порадует наших клиентов!</p>
        </div>
      </div>
    </div>
  </div>
