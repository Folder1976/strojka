...
$_['smsru_number_tooltip']		= 'Обязательно используйте международный формат: +79876543210. Чтобы бесплатно получать СМС-сообщения - необходимо чтобы номер совпадал с номером в личном кабинете sms.ru<br />* Сообщения на собственный номер <strong>бесплатны до 5 СМС в день</strong> при условии, что каждое сообщение помещается в 1 СМС (до 70 русских / 160 латинских символов). При превышении этих лимитов, сообщения оплачиваются согласно тарифу.';
...
$_['smsru_admin_sms_tooltip']	= 'Стандартный шаблон СМС администратору: Заказ: {product}. Покупатель: {name} {phone} {email} <br /><strong>Если не знаете что вписать - оставьте пустым!</strong> Подробнее о шаблонах Вы можете прочитать здесь: <a href="http://ocshop.xdomus.ru/buy_one_click.htm" target="_blank">FAQ по модулю</a>';
$_['smsru_client_sms_title']	= 'Шаблон сообщения клиенту';
$_['smsru_client_sms_tooltip']	= 'Стандартный шаблон СМС клиенту: Спасибо за Ваш заказ на {product} в интернет-магазине: "{shop_name}"! Мы свяжемся с Вами для подтверждения заказа! <br />Подробнее о шаблонах Вы можете прочитать здесь: <a href="http://ocshop.xdomus.ru/buy_one_click.htm" target="_blank">FAQ по модулю</a>';
...
// TurboSMS
$_['turbosms_form_title'] 		= 'Настройка <strong>Turbo</strong>SMS';
...
$_['turbosms_client_sms_tooltip']	= 'Стандартный шаблон СМС клиенту: Спасибо за Ваш заказ на {product} в интернет-магазине: "{shop_name}"! Мы свяжемся с Вами для подтверждения заказа! <br />Подробнее о шаблонах Вы можете прочитать здесь: <a href="http://ocshop.xdomus.ru/buy_one_click.htm" target="_blank">FAQ по модулю</a>';
