...
$_['text_new_greeting_store']         = 'Поступил новый заказ, %s';
$_['text_new_greeting']         = '<h1>Уважаемый(я), %name%</h1>,
										Ваш заказ номер <b>%order_id%</b>, от %order_date% - <b>принят</b>.<br><br>
										Стоимость заказа <b>%total%</b><br><br>
										Пожалуйста, при обращении к администрации сайта %store_name% ОБЯЗАТЕЛЬНО указывайте номер Вашего заказа - <b>%order_id%</b>
										';
