      ...
      <div class="col-md-11 col-md-offset-1">
        <div class="section-home-top__content">
          ...
          <div class="section-home-top__desc">
            ...
            <br>
            <a href="/krovlya/stroitelstvo-krysh#online-calc" class="btn btn--orange btn--dib btn--w100">сделайте расчёт за 50 секунд</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <div class="content-style">
          <p>Компания «Руфер» находится на рынке кровельно – монтажных работ с 2007 года. В нашем активе имеется свыше 500 конструкций, возведенных специалистами – монтажниками фирмы на территории мегаполиса и области. В штате компании состоят более 40 опытных высококвалифицированных мастеров с большим опытом работы, которые готовы взяться за монтаж крыши любой сложности – от плоских крыш до вальмовой кровли с усложняющими элементами типа башенок, мансардными этажами и окнами несимметричного расположения и др. компонентами. Все виды монтажных работ проводятся по четкому графику, по утвержденной смете и с выполнением временных нормативов. Стоимость нашей работы не превышает расценок компаний – лидеров в этом сегменте, а за счет приобретения кровельных материалов у наших контрагентов конечная цена заказа будет дешевле.</p>
          <p>Предлагаем потенциальным клиентам связаться по телефону с нашими менеджерами, которые за непродолжительный промежуток времени подготовит сметную документацию с учетом скидок и приятно удивят стоимостью заказа. Все работы выполняются специалистами «под ключ», включая уборку рабочих мест после ремонта.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="section section-text">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="section-title">Расчет строительства кровли</div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <div class="content-style">
          <p>При калькуляции стоимости заказа в расчет принимаются все виды производимых кровельных работ, в зависимости от квадратуры объекта монтажа. К таким видам работ следует отнести:</p>
          <p><b>1. Обустройство кровли на примере двухскатной крыши и вальмовой конструкции.</b></p>
          <p>Для возведения кровельной конструкции с 2 ск4атами необходимо закрепить требуемое количество стропил (количество зависит от площади крыши) и стянуть их ригельными элементами, опирающиеся на мауэрлаты. При строительстве крыши вальмового типа монтажные работы дополнительно усложняются необходимостью создания некоторого количества скатов с добавлением диагональных стропил в местах пересечения скатов. При этом поддерживающий каркас конструкции должен быть усилен промежуточными стойками, опирающимися на лежни. Соответственно стоимость такой усложненной кровли будет дороже на 10-20 процентов от общей суммы затрат.</p>
          <p><b>2. Укладка утеплительного и гидроизоляционного слоя. </b></p>
          <p>Для таких видов работ по приданию кровле улучшенных свойств потребуется дополнительная закупка материалов и время, поэтому при окончательном расчете стоимость возрастет на 10-15 процентов.</p>
          <p><b>3. Тип применяемой кровли.</b></p>
          <p>Среди расценок монтажных работ самые низкие цены при укладке металлочерепицы, т. к. это материал комфортной укладки. Значительно большие трудозатраты прикладываются при монтаже таких видов кровли, как глиняная черепица или сланец, при работе с которыми требуется точность, аккуратность и профессиональный инструмент.</p>
          <p><b>4. Габариты крыши.</b></p>
          <p>Стоимость кровельного покрытия рассчитывается за единицу площади (м2). Здесь все находится в прямой пропорции - при большей площади возрастает ее общая стоимость.</p>
        </div>
      </div>
    </div>
  </div>
