...
$services = array(
  ...
  array(
    ...
    'desc' => 'Создание проекта кровли – достаточно не простая задача, в решении которой потребуются академические знания и расчеты инженеров по возведению конструкции, создать требуемый дизайн помогут наши проектировщики.',
