          ...
          <?php foreach ($products as $product) { ?>
            <div class="news-list__item news-item">
              ...
              <div class="news-item__desc">
				...
				<?php
				//https://youtu.be/LZOzpBhzb4I
				//<iframe width="560" height="315" src="https://www.youtube.com/embed/LZOzpBhzb4I" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				
					$product['description'] = str_replace('https://youtu.be/', 'https://www.youtube.com/embed/', $product['description']);
				?>
				
				<iframe width="560" height="315" src="<?php echo $product['description']; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
